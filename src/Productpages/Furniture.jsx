...
const Furniture = () => {
    return (
        <div className="Furnipage">
            <h1 className="heading">
                <img src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTAELJTNqeBuN4Ab5CjiZ3OOsHcPqhmeG0Dx_XrmDr5Nmf7EThn" width="60px" height="70px" alt="Furniture" />
                Furniture on rent
            </h1>
                ...
                <div className="box1 box">
                    <div className="box-content">
                        ...
                        <div>
                            ...
                            <div className="p1"><p><img src="https://www.rentomojo.com/public/images/fast-delivery/fast-delivery.svg" alt="Fast delivery" /> 3-5 days</p></div>
                        </div>
                    </div>
                </div>
